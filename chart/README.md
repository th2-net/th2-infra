...
| infraEditor.image.tag | string | `"1.1.10"` |  |
...
| infraMgr.git.privateKey | string | `""` |  |
...
| infraMgr.image.tag | string | `"1.7.20"` |  |
...
| infraOperator.image.tag | string | `"3.6.6"` |  |
...
| infraRepo.image.tag | string | `"1.8.0@sha256:d824dba77abf49be8edc4c4c8d9dfadb43b086ea8a5f02676494d257178dc6d0"` |  |
