...
| infraMgr.image.tag | string | `"1.7.12-infra-1.8.0-2185133265"` |  |
...
| infraOperator.image.tag | string | `"3.6.2-infra-1.8-2188526846"` |  |
...
| ingress.host | string | `""` | Hostname to access ingress |
| productRegistry.name | string | `""` |  |
| productRegistry.password | string | `""` |  |
| productRegistry.secret | string | `"th2-core"` | Image repository and credentials to create pull secrets |
...
| proprietaryRegistry.registry | string | `""` | Registry host e.g. myregistry.com:6000 |
...
| solutionRegistry.registry | string | `""` | Registry host e.g. myregistry.com:6000 |
