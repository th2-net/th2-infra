...
| infraOperator.image.tag | string | `"3.6.3-infra-1.8-2194615570"` |  |
...
| registries | object | `{}` | Registries are attached as pull secrets to pods registries:   myregistry.com:     username: user     password: password |
