...
| infraEditor.image.tag | string | `"1.1.0"` |  |
...
| infraMgr.image.tag | string | `"2.1.3-infra-2.0-2489430906"` |  |
...
| infraOperator.image.tag | string | `"4.2.2-nametype-refactor-2415466147"` |  |
...
| infraRepo.image.tag | string | `"2.0.0-alpha1"` |  |
