...
| converter.image.tag | string | `"1.3.3"` |  |
...
| infraMgr.image.tag | string | `"2.3.2"` |  |
...
| infraOperator.image.tag | string | `"4.5.3"` |  |
...
| storageService.image.tag | string | `"1.0.0-owasp-4251615853-d9c095f"` |  |
