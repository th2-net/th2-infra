...
| infraMgr.image.tag | string | `"1.7.22"` |  |
...
| infraOperator.image.tag | string | `"3.6.9"` |  |
...
| infraRepo.image.tag | string | `"1.8.0@sha256:aa8987dcd6498c59a87287df23e6d4c902ecb09c5255a0357ecd4309bb0ada92"` |  |
